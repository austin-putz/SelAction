!     Last change:  MR   14 Sep 2000    2:37 pm
	...
	real :: temp3sigmai,srih,drih,sigmah,errpart,comenvpart,genpart
        ...
        real*8 :: seuil1,seuil2,seuil3,dumpvald3,dumpvals3,dutt2
        real*8 :: dumpvals,dumpvald,dumtrunc1s,dumtrunc1d,dumcorrsrih,dumcorrdrih
        real*8 :: dumtrunc2s,dumtrunc2d,dumpvals2,dumpvald2,dumtrunc3s,dumtrunc3d
        real*8 :: dumcorrsrih12,dumcorrsrih13,dumcorrsrih23,dumcorrsrih123,dumcorrsrih231
        real*8 :: dumcorrsrih132,dumr,dumt,dumcorrdrih213,dumcorrdrih312,dumcorrdrih321
        real*8 :: dumcorrdrih12,dumcorrdrih13,dumcorrdrih23,dumcorrdrih123,dumcorrdrih231
        real*8 :: dumcorrdrih132,dumcorrsrih213,dumcorrsrih312,dumcorrsrih321
        real*8 :: t12d,t21d,t13d,t31d,t23d,t32d,t12s,t21s,t13s,t31s,t23s,t32s
        real, dimension(1,1) :: tempcov3,tempcov4,g1,g2,g3
        real, allocatable, dimension(:,:) :: v
        real*8, allocatable, dimension(:,:) :: dumv
